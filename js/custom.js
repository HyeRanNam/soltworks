$(document).ready(function(){
	...
	$(".section").on("mousemove",function(e){		
		...
		$(".p11").css({"right":20-(posX/50) , "bottom":-20-(posY/50) });
		$(".p12").css({"right":90+(posX/50) , "bottom":90+(posY/50) });
		$(".p13").css({"left":50-(posX/100) , "bottom":0-(posY/100) });		
		$(".p14").css({"right":150+(posX/100) , "bottom":0+(posY/100) });		
